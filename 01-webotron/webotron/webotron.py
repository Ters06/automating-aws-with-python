...
It automates the process of deploying static web sites to AWS.
...
def setup_domain(domain):
    ...
    a_record = domain_manager.create_s3_record(zone, domain, endpoint)
...
def find_cert(domain):
    """Find a certificate with a DOMAIN."""
...
def setup_cdn(domain, bucket):
    """Set CloudFront for our Website."""
    ...
    domain_manager.create_cf_record(zone, domain, dist['DomainName'])
